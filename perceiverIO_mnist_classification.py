### Program implementing PerceiverIO and training for classifying MNIST images
...
if __name__ == '__main__':
    ...
    o_seqlen = 1 # since class scores are scalars # O in paper fig.2
    o_dim = 10 # since 10 classes in MNIST # E in paper fig.2
