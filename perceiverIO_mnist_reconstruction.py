...
if __name__ == '__main__':
    ...
    checkpoint_path = 'ckpts/perceiverIO_mnist_reconstruction.pt' # path to a save and load checkpoint of the trained model
    ...
    plt.savefig('plots/perceiverIO_mnist_reconstruction_DataAug' + hyperparam_str + '.png')